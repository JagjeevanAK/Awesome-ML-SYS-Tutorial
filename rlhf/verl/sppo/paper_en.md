...
```
The loss in the original SPO text, due to the low computational efficiency of \( \widehat{P}(y \succ \pi_t \mid \mathbf{x}) \), you can use the loss in Kimi K1.5:
